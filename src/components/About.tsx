        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <ScrollReveal direction="right">
            <div className="glass p-1 rounded-xl overflow-hidden">
              <div className="rounded-lg overflow-hidden aspect-square bg-gradient-to-br from-gray-200 to-gray-100 flex items-center justify-center">
                <div className="font-bold text-6xl text-primary">AC</div>
              </div>
            </div>
          </ScrollReveal>
            ...
            <ScrollReveal delay={0.6} direction="up">
              <div className="mt-8 flex items-center space-x-4">
                <a 
                  ...
                  className="p-3 rounded-full bg-background hover:bg-primary hover:text-white transition-colors"
                  aria-label="GitHub"
                >
                  <Github size={20} />
                </a>
